...
Let's think step by step.
Answer: 
Let the length of the ship be x metres and its speed be y m/sec. Then, x / y = 60 
y = x / 60
2234 (x + 750) / 240 = x / 60 
4 x = 250 m. 
[ANSWERKEY] D
...
Let's think step by step.
Answer: 
For a point to satisfy the given equation for all possible values of k, then x must equal 0.
